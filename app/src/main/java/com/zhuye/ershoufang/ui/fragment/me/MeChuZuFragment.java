...
public class MeChuZuFragment extends BaseFragment {
    ...
    public void setData(int position) {
       CommonApi.getInstance().sellhouselists(getToken(), 1, cate_id, MeChuZuFragment.this, LIST);
    ...
    protected void initListener() {
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()){
                    case R.id.delete:
                        CommonApi.getInstance().del_house(getToken(),cate_id,MeChuZuFragment.this,DELETE);
                        break;
                    case R.id.edit:
